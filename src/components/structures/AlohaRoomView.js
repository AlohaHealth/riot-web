...
const ContentMessages = require("matrix-react-sdk/lib/ContentMessages");
const Modal = require("matrix-react-sdk/lib/Modal");
const sdk = require('matrix-react-sdk/lib/index');
const CallHandler = require('matrix-react-sdk/lib/CallHandler');
import dis from 'matrix-react-sdk/lib/dispatcher';
const Tinter = require("matrix-react-sdk/lib/Tinter");
const rate_limited_func = require('matrix-react-sdk/lib/ratelimitedfunc');
const ObjectUtils = require('matrix-react-sdk/lib/ObjectUtils');
const Rooms = require('matrix-react-sdk/lib/Rooms');
...
import RoomScrollStateStore from 'matrix-react-sdk/lib/stores/RoomScrollStateStore';
import SettingsStore, {SettingLevel} from "matrix-react-sdk/lib/settings/SettingsStore";

// Aloha's Clinical Trial List Component
import AlohaClinicalTrialList from '../views/aloha/clinicalTrials/AlohaClinicalTrialList';
